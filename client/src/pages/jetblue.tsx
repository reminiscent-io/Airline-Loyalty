...
export default function JetBlue() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Hero Section */}
      <section className="relative h-[400px] md:h-[500px] bg-gradient-to-br from-jetblue-navy via-jetblue-mid to-jetblue-cyan overflow-hidden">
        <HeroPattern />
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="max-w-4xl mx-auto px-4 md:px-6 text-center relative z-10">
            <div className="inline-flex items-center gap-2 mb-4">
              <Cloud className="w-8 h-8 text-white" />
              <Plane className="w-8 h-8 text-jetblue-orange" />
            </div>
